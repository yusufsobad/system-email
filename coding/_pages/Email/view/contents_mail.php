...
class contents_mail extends template_mail{

	protected static $object = 'contents_mail';
	...
	protected static function table(){
		...
		$user = get_id_user();
		$where = "AND type='0'"; // AND user='$user'
		if(self::$search){		
	...
	protected static function head_title(){
		$args = array(
			'title'	=> 'Content Email<small>content email</small>',
			'link'	=> array(
				0	=> array(
					'func'	=> self::$object,
					'label'	=> 'content email',
	...
	public static function add_form(){
		$vals = array(0,'','',date('Y-m-d'),0,get_id_user(),0);
